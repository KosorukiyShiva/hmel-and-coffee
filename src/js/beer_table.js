...
beer_menu_sqr_button.style.left = `${(windowInnerWidth - 346)/2}px`
if (windowInnerWidth >= 500) {
    ...
    beer_menu_sqr_brewery_column.style.left = `${38 + (prcnt_windowInnerWidth*20) + 4}px`
    beer_menu_sqr_style_column.style.left = `${38 + (prcnt_windowInnerWidth*20) + 4 + (prcnt_windowInnerWidth*18) + 4}px`
    beer_menu_abv_style_column.style.left = `${38 + (prcnt_windowInnerWidth*20) + 4 + (prcnt_windowInnerWidth*18) + 4 + (prcnt_windowInnerWidth*18) + 4}px`
    beer_menu_ibu_style_column.style.left = `${38 + (prcnt_windowInnerWidth*20) + 4 + (prcnt_windowInnerWidth*18) + 4 + (prcnt_windowInnerWidth*18) + 4 + (prcnt_windowInnerWidth*10) + 4}px`
    beer_menu_sqr_0305_column.style.left =  `${38 + (prcnt_windowInnerWidth*20) + 4 + (prcnt_windowInnerWidth*18) + 4 + (prcnt_windowInnerWidth*18) + 4 + (prcnt_windowInnerWidth*10) + 4 + (prcnt_windowInnerWidth*10) - 5}px`
...
if (windowInnerWidth < 500) {
    ...
    beer_menu_sqr_0305_column.style.left =  `${38 + (prcnt_windowInnerWidth * 24.2) + 8 + (prcnt_windowInnerWidth*21.8) + 8 + (prcnt_windowInnerWidth*21.8) + 8}px`
